    ...
    RenderTable.prototype = {
        ...
        select: function (index) {
            if (hasClass(this.tBody_rows[index], 'selected-bgColor')) {
                ...
                var removeIndex =findOnArray(beSelectedUser,document.getElementById("id"+(index+1)).innerHTML);
                if (removeIndex !== -1) {
                    beSelectedUser.splice(removeIndex,1);
                }
                ...
                this.select_num++;
                beSelectedUser.push(document.getElementById("id" + (index + 1)).innerHTML);
