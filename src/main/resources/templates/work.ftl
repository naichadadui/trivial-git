    ...
    <div id="contents">
        <div>
            ...
            <ul id="gallery">
                ...
                <li id="room2">
                    <img src="/images/zombie.jpg" onclick="clickRoom(this.id)">
                    <h4 id="title2">room No.2</h4>
                    <h4 id="ratio2"></h4>
                    <h4 id="state2"></h4>
                </li>
                <li id="room3">
                   <img src="/images/doctor.jpg" onclick="clickRoom(this.id)">
                    <h4 id="title3">room No.3</h4>
                    <h4 id="ratio3"></h4>
                    <h4 id="state3"></h4>
                </li>
                <li id="room4">
                    <img src="/images/scientist.jpg" onclick="clickRoom(this.id)">
                    <h4 id="title4">room No.4</h4>
                    <h4 id="ratio4"></h4>
                    <h4 id="state4"></h4>
                </li>
                <li id="room5">
                    <img src="/images/viking.jpg" onclick="clickRoom(this.id)">
                    <h4 id="title5">room No.5</h4>
                    <h4 id="ratio5"></h4>
                    <h4 id="state5"></h4>
                </li>
                <li id="room6">
                    <img src="/images/pirate.jpg" onclick="clickRoom(this.id)">
                    <h4 id="title6">room No.6</h4>
                    <h4 id="ratio6"></h4>
                    <h4 id="state6"></h4>
                </li>
                <li id="room7">
                    <img src="/images/caveman.jpg" onclick="clickRoom(this.id)">
                    <h4 id="title7">room No.7</h4>
                    <h4 id="ratio7"></h4>
                    <h4 id="state7"></h4>
                </li>
                <li id="room8">
                    <img src="/images/vendor.jpg" onclick="clickRoom(this.id)">
